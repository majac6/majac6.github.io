  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        achievements: ['일러스트 게재 기능 추가', '도네이션(Meow) 을 통해 새로운 BM 도입'],
      },
      {
        name: 'iOS App 출시',
      ...
      },
      {
        ...
        achievements: ['웹툰 뷰어 및 디자인 시스템 구축', '소셜 로그인 등 다양한 기능 구현'],
      },
      {
        name: '스튜디오 웹 개발',
        ...
        achievements: ['웹툰 생성/에디터/디자인 시스템 등 창작자 기능 강화'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        roles: ['컨테이너 패턴 적용', 'callback 패턴/DeBounce 적용'],
        achievements: [],
      },
      {
        name: '카닥몰 2차 업데이트',
        ...
        roles: ['상품/전시 관련 페이지 개발', '상태 및 코드 최적화', '컨테이너 패턴 적용'],
        achievements: [],
      },
      {
        ...
        stack: ['React', 'Typescript', 'Context', 'Hooks', 'SCSS'],
        roles: ['동적 컴포넌트 구성', '컴포넌트 최적화', '컨테이너 컴포넌트간 통신규약/내부 교육'],
        achievements: [],
      },
      {
        ...
        roles: ['프로젝트 개발 리드', '컨테이너 패턴/카드번호 input masking hook', 'Context 활용 리렌더링 컨트롤'],
        achievements: ['결제 로비 일원화, 서비스별 결제수단 추가/삭제시 일괄 적용', '레거시 코드 활용으로 빠르고 안정성 높은 개발'],
      },
      {
        name: '프론트엔드 모든 프로젝트 모노레포(Monorepo) 전환 및 CI/CD 개선',
        duration: '2019.12 - 2020.01',
        description:
          'MSA+모놀리식 방식에서 yarn workspace로 모노레포 전환, 젠킨스→github Action, 도커 전환, 쉘스크립트/cli 툴 제작, 팀 내 교육.',
        ...
        achievements: ['모노레포로 배포 시간 단축, 저장소 수 대폭 감소', '젠킨스→github Action으로 CI/CD 개선'],
      },
      {
        ...
        roles: ['불필요한 의존성 해제', 'Function 컴포넌트 사용 지향', '공통 디자인 컴포넌트/엘리먼트 작성'],
        achievements: [],
      },
      {
        name: '카닥 4.0 업데이트',
        ...
        roles: ['컨테이너 패턴/커스텀 화면전환 애니메이션', '공통 행동 Hooks, Function 컴포넌트, 스토리북 활용'],
        achievements: [],
      },
      {
        name: '카닥 앱 마이카 업데이트',
        ...
        roles: ['웹뷰용 모놀리식 프로젝트 구성', '컨테이너 패턴/커스텀 애니메이션/공통 Hooks/Function 컴포넌트'],
        achievements: [],
      },
      {
        ...
        roles: ['Adobe XD로 목표/프로토타입 제작', 'Boiler Plate/기본 레이아웃/견적요청 기능 작성'],
        achievements: [],
      },
    ],
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          'On Premise 서버 환경을 AWS 등 Cloud로 자동 전환하는 웹 콘솔. 서버/클라우드 인증정보 입력→환경 분석→클라우드 자동 마이그레이션. 디자인/관리자 콘솔 작업.',
    ...
    projects: [
      {
        ...
        description:
          '딜러용 차량 경매 하이브리드 앱(iOS, Android 동시 배포). 경매, 차량 상태/사고/보험/가격정보, 낙찰 후 추가정보/서류처리 등 구현.',
      ...
      },
      {
        ...
        description:
          'LPG 중고차 구매 하이브리드 앱(iOS, Android 동시 배포). 차량 상태/사고/수리/보험 등 정보 제공, 계약/탁송 등 프로세스 구현.',
        stack: ['Framework7', 'SCSS', 'Cordova', 'PHP'],
        roles: ['프론트엔드 개발환경 구성 및 기능 구현', 'Framework7 기반 페이지 구조 개발', 'SCSS 기반 스타일 클래스 작성'],
        achievements: [],
      },
      {
        name: '박차 비즈 웹사이트 개발',
        ...
        description:
          '중고차 양수도 전용 웹사이트. carvana 참고, 좌측 필터/차종/색상/연식/주행거리/제조사 등 부드러운 목록 전환, 상세 페이지 UX 개선.',
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          '귀금속 주문~배송까지의 내부 업무 프로세스 웹앱. 주문→발주→입고→배송, 매출 대시보드, Lumen 기반 백엔드, 협업. 현재도 간헐적 유지보수.',
