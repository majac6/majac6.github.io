							...
							<div className="col-sm-9">
								<ul>
									...
									<li>
										...
										<div>
											Meteor 에서 사용하기 위해 다음 주소찾기를 미티어 패키지
											제작
										</div>
							...
							<div className="col-sm-9">
								<ul>
									<li>
										...
										<div>
											기존 종이로 처리하던 업무 시스템을 웹앱으로 전환 및 AWS +
											Docker 로 배포 및 개발환경 구성
										</div>
							...
							<div className="col-sm-9">
								<ul>
									<li>
										...
										<div>
											AWS 행사에서 회사 대표로 '데이터 센터 모던화' 에 대해 발표
										</div>
									...
									<li>
										...
										<div>
											사내에서 진행된 행사에서 'Javascript로 할수있는 일들' 에
											대해 발표
										</div>
