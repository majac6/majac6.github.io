          ...
          <div className='container'>
            <div className='row'>
              ...
              <div className='col-sm-12 mb-4'>
                <p className='text-lg'>
                  안녕하세요 프론트앤드 개발자 임흥선입니다. 처음 개발을 시작하고 AngularJS 를 만난후 프론트앤드 개발자로써 첫 시작을 하였습니다. 지금은 React
                  를 위주로 사용하고 있고 이 분야에서 최고가 되기 위해 노력하고 있습니다.
                </p>
              </div>
            ...
            <div className='row'>
              ...
              <div className='col-sm-8'>
                <div className='project'>
                  ...
                  <p className='description'>
                    월초에 제작했던 cg 커맨드는 컨테이너와 컴포넌트만 생성이 가능하였으나 기능을 추가로 개선해 페이지, 엘리먼트 등도 이 커맨드를 이용해 자동으로
                    생성할수 있도록 추가하였고 헤당 프로젝트가 JS ,TS 인지를 옵션으로 부여받았지만 프로젝트 루트폴더의 index.js or ts 를 보고 자동으로 이
                    프로젝트의 메인 언어를 파악하는 방식으로 변경하였습니다. 그리고 각 컴포넌트 타입에 따라 필요한 패키지를 미리 첨부해두는 식으로 작업자의
                    피로를 덜 수 있는 방향으로 업데이트하였습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <div className='date'>2020.05</div>
                  <p className='description'>
                    마이카의 프로필 페이지를 도입할 필요성이 있기에 새로운 UI를 적용하였고 기존 레거시 코드를 개선하는 작업도 함께 이루어졌습니다. 기존에는 page
                    를 메인으로 두고 하단에 추가적인 페이지를 만드는 방식으로 구현되었지만 몰 작업때 완전히 정착된 컨테이너 패턴을 적용해 레거시와 독립된 형태로
                    구성하였습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    카닥몰 최초 업데이트 이후 후속으로 진행된 프로젝트입니다. 기존 디자인 패턴을 유지하면서 상품 검색,목록,상세,후기 및 상품문의 등 장바구니
                    이전 단계까지의 흐름을 구현하였고 이 부분을 1개의 컨테이너로 구현하였습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    통합결제 프로젝트와 병행으로 진행되었으며 기존 워드프레스의 view 를 사용하지 않고 프론트앤드 사이드는 별도로 작성해 빠른 페이지 로딩과
                    카닥에서 제공하는 UI/UX 를 첫 페이지에 도입하는 프로젝트입니다.
                  </p>
                  <h5>사용 기술</h5>
                  <p className='tech'>React, Typescript, Context, Hooks, Docker, k8s(AWS EKS)</p>
                  <h5>역할</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    각 서비스별로 독립적으로 작용했던 결제창을 하나로 통합하고, 유저가 자신의 신용카드를 직접 등록해 반복적으로 사용할수 있도록 추가되었습니다.
                    그리고 새롭게 템플릿 패턴을 통해 반복적인 페이지의 레이아웃을 컴포넌트화 하는 작업도 진행되었습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    ...
                    구상했던 방식을 12월 외부 세미나에서 TOSS팀의 개발방식에 대해 이야기를 듣고 난 뒤 좀 더 확신하게 되었고 이를 실제 구현하였으며 이를
                    도입하면서 젠킨스가 아닌 github Action 으로 CI/CD 툴을 변경하였습니다. 이 시점부터 모든 프론트앤드 프로젝트는 도커로 전환되었습니다. 그리고
                    쉘스크립트와 cardoc-react-generator(cg cli) 를 만들어 모든 개발자가 동일한 컨벤션을 가질 수 있도록 툴로써 제공하였습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    카닥의 테크샵(엔진오일), 워시(세차) 서비스는 모두 100% 웹뷰로만 구성되어 있습니다. 그리고 이 웹뷰는 네이티브 앱과 JS인터페이스를 통해 긴밀히
                    통신하기에 이 부분에 유의해야 하고 매우 안 좋은 구조의 리액트 패턴으로 작업되어 있기에 이 부분도 일부 함께 개선되었습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>카닥 4.0에서는 모든 웹뷰의 디자인 업데이트와 새로 추가된 쿠폰함, 쇼핑탭 및 쿠폰과의 연동 작업이 진행되었습니다.</p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    앱 사용자들을 위해 자신의 차량을 등록하고, 이미 개발된 카닥의 모든 서비스를 이용할 수 있는 마이카 기능 업데이트 작업입니다. 이 작업은
                    Android, iOS 에서 WebView 로 사용해야 하기 때문에 그것을 전제 조건으로 개발하였고 내부 운영을 위한 백오피스도 함께 업데이트 되었습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    카닥은 모바일 어플리케이션을 Native + WebView 를 사용해 제작하고 있었는데 내부적인 테스트를 위해 React Native 를 활용하여 간단하게 현재의
                    앱의 일부 기능을 샘플로 제작하였습니다.
                  </p>
                  <h5>사용 기술</h5>
              ...
              <div className='col-sm-8'>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    기존 On Premise 서버 환경을 AWS 와 같은 Cloud 환경으로 자동 전환해주는 프로젝트로 웹 콘솔을 통해 서버, 클라우드 인증정보 등을 입력하면 기존
                    서버의 환경을 분석해 클라우드로 자동 마이그레이션이 가능한 툴입니다. 현재는 디자인 업데이트와 관리자 콘솔을 작업하고 있습니다.
                  </p>
                  <h5>사용 기술</h5>
                  <p className='tech'>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    사내에서 개발한 제품을 소개하기 위한 Static 웹사이트입니다. 제품의 종류와 소개 그리고 한/영 번역과 markdown blog 로 제품관련 소식을
                    전달했습니다.
                  </p>
                  <h5>사용 기술</h5>
              ...
              <div className='col-sm-8'>
                <div className='project'>
                  ...
                  <p className='description'>
                    딜러들을 위한 차량 경매 어플리케이션으로 iOS, Android 동시 배포를 위해 하이브리드 앱으로 작성 되었습니다. 기본적인 경매 기능을 중심으로
                    차량의 아주 디테일한 상태와 사고, 보험이력, 가격정보 그래프 등의 정보 제공과 낙찰 이후의 추가정보나 서류제출등의 과정도 함께 처리할 수
                    있도록 제작되었습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    일반 고객 대상의 LPG 전문 중고차 구매 어플리케이션으로 iOS, Android 동시 배포를 위해 하이브리드 앱으로 작성 되었습니다. 중고차 특성상 상태,
                    사고여부, 수리여부, 보험이력 등의 많은 정보를 효율적으로 전달하기 위해 신경써서 제작하였고, 차량 구매 이후 계약 진행과 탁송여부등도
                    어플리케이션을 통해 손쉽게 진행할수 있도록 제작되었습니다.
                  </p>
                  <h5>사용 기술</h5>
                  <p className='tech'>Framework7, SCSS, Cordova, PHP</p>
                  <h5>역할</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    중고차 양수도를 위해 허용된 이용자만 사용 가능한 웹사이트입니다. 해외 서비스인 carvana 를 참고해 개발하였고 좌측 필터를 통해 차종, 색상,
                    연식, 주행거리, 제조사 등의 값을 변경하면 부드럽게 목록이 전환되도록 작성하였으며 목록과 상세 페이지 전환시에도 사용자가 불편함을 느끼지
                    않도록 개발하였습니다.
                  </p>
                  <h5>사용 기술</h5>
              ...
              <div className='col-sm-6'>
                <div className='project'>
                  ...
                  <p className='description'>
                    기존 1.0 버전에서 새로운 제품군이 추가되고 다양한 요구사항을 수용하기 위해 2.0 리워크를 결정하였으며 개발 환경도 함께 변경하였습니다. 구글맵
                    지도 기반에서 각 사용자별 자신의 제품을 효율적으로 관리할 수 있도록 수정되었으며, 지도 위에 많은 제품을 보여주기 위해 마커 그룹화 및 실시간
                    필터링을 제공하였습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    성형외과 등 주로 비급여 항목을 다루는 병원들의 마케팅 플랫폼으로 제작되었고 일반 사용자의 성형후기 게시 및 공유, 병원정보, 병원검색, 나에게
                    맞는 병원 찾기 기능과 병원 관리자 페이지를 통해 자신의 병원에 관심이 있거나 관심이 있을만한 유저를 추천하고, 메시지를 보내거나 자신의 병원과
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    태양광 압축 쓰레기통 이라 불리는 자사 제품을 컨트롤하기 위한 웹 브라우저 기반 콘솔입니다. 지도 기반 페이지에서 각 제품별 폐기물량, 배터리
                    충전량, 마지막 수거 시간 등의 정보와 지금까지의 쓰레기 발생량이나 발생량이 많은 지역등의 수집된 정보, 그리고 수집된 정보를 바탕으로 한
                    쓰레기통 추가 배치가 필요한 지역과 발생량 추이 등의 데이터를 제공하였습니다. 현장 수거자를 위해서 모바일 앱 개발도 필요했기에 하이브리드
                    앱도 제작하였고 알파, 베타를 거쳐 1.0 버전까지 업데이트가 이루어졌습니다.
                  </p>
                  <h5>사용 기술</h5>
              ...
              <div className='col-sm-8'>
                <div className='project'>
                  ...
                  <p className='description'>
                    PHP 기반 오픈소스인 영카트5 를 활용해 베트남 쇼핑몰을 구축하였습니다. 기본 기능을 귀금속 쇼핑몰에 맞게 커스터마이징 하고 docker-compose 를
                    이용해 앱에서 사용되는 미들웨어를 관리하였으며 글로벌 서비스이기에 aws EC2 instance 및 RDB 그리고 S3 + CloudFront 을 사용했습니다.
                  </p>
                  <h5>사용 기술</h5>
                ...
                <div className='project'>
                  ...
                  <p className='description'>
                    개인 사업자분 으로부터 의뢰받아 진행한 프로젝트로 귀금속을 주문받아 고객에게 발송될때까지의 내부적인 업무 프로세스를 웹앱으로 작성하였으며,
                    제품 주문 -> 발주 -> 입고 -> 배송 의 과정을 처리하고 매출 등의 자료를 대시보드를 통해 보여주는 작업을 진행하였습니다. 현재는 간혹 있는
                    요구사항을 처리하고 있습니다. 백엔드는 PHP 기반의 Lumen 으로 작성하였고 다른 개발자와 협업하였습니다.
                  </p>
                  <h5>사용 기술</h5>
            ...
            <div className='row'>
              ...
              <div className='col-sm-6'>
                <div className='project'>
                  ...
                  <p className='description'>
                    AWS 행사에서 회사 대표로 '데이터 센터 모던화' 에 대해 발표했고, 주로 자사 제품을 통한 클라우드 전환, Docker, DevOps 관련 내용을
                    정리하였습니다.
                    {'  '}
                    <a
